...
extension Translations {
    static let english: [String: String] = [
        ...
        "wifi.edit": "Edit",
        "wifi.save": "Save",
        "wifi.hideSsid": "Hide network name",
        "wifi.restartWarning": "Saving restarts the Wi-Fi radio and disconnects connected devices.",
        "wifi.saved": "Wi-Fi settings saved",
        "status.noService": "No service",

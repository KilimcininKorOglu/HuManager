...
extension Translations {
    static let greek: [String: String] = [
        ...
        "status.plmn": "PLMN",
        "wifi.edit": "Επεξεργασία",
        "wifi.save": "Αποθήκευση",
        "wifi.hideSsid": "Απόκρυψη ονόματος δικτύου",
        "wifi.restartWarning": "Η αποθήκευση επανεκκινεί το Wi-Fi και αποσυνδέει τις συνδεδεμένες συσκευές.",
        "wifi.saved": "Οι ρυθμίσεις Wi-Fi αποθηκεύτηκαν",
        "status.noService": "Χωρίς υπηρεσία",
        "status.networkTypeCode": "Τύπος: %@",

...
extension Translations {
    static let romanian: [String: String] = [
        ...
        "wifi.edit": "Editează",
        "wifi.save": "Salvează",
        "wifi.hideSsid": "Ascunde numele rețelei",
        "wifi.restartWarning": "Salvarea repornește Wi-Fi și deconectează dispozitivele conectate.",
        "wifi.saved": "Setări Wi-Fi salvate",
        "status.noService": "Fără serviciu",
        "status.networkTypeCode": "Tip: %@",

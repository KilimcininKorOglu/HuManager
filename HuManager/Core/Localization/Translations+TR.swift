...
extension Translations {
    static let turkish: [String: String] = [
        ...
        "wifi.edit": "Düzenle",
        "wifi.save": "Kaydet",
        "wifi.hideSsid": "Ağ adını gizle",
        "wifi.restartWarning": "Kaydetmek Wi-Fi radyosunu yeniden başlatır ve bağlı cihazların bağlantısını keser.",
        "wifi.saved": "Wi-Fi ayarları kaydedildi",
        "status.noService": "Bağlantı yok",
        "status.networkTypeCode": "Tür: %@",

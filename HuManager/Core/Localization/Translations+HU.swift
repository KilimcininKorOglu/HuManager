...
extension Translations {
    static let hungarian: [String: String] = [
        ...
        "status.plmn": "PLMN",
        "wifi.edit": "Szerkesztés",
        "wifi.save": "Mentés",
        "wifi.hideSsid": "Hálózatnév elrejtése",
        "wifi.restartWarning": "A mentés újraindítja a Wi-Fi rádiót és bontja a csatlakozott eszközöket.",
        "wifi.saved": "Wi-Fi beállítások mentve",
        "status.noService": "Nincs szolgáltatás",
        "status.networkTypeCode": "Típus: %@",
        "general.unknown": "Ismeretlen",

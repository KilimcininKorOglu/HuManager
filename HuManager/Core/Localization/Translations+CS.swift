...
extension Translations {
    static let czech: [String: String] = [
        ...
        "wifi.edit": "Upravit",
        "wifi.save": "Uložit",
        "wifi.hideSsid": "Skrýt název sítě",
        "wifi.restartWarning": "Uložení restartuje Wi-Fi a odpojí připojená zařízení.",
        "wifi.saved": "Nastavení Wi-Fi uloženo",
        "status.noService": "Bez signálu",
        "status.networkTypeCode": "Typ: %@",
        "general.unknown": "Neznámé",
